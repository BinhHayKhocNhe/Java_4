		...
		<div class="container">
			<div class="row">
				<div
					...
					<div>
						<a href="" class="text-decoration-none text-black"> <i
							class="bi bi-house"> <span>Hệ thống cửa hàng</span>
						</i></a>
					</div>
				</div>
				<div class="col-lg-4 d-none d-lg-block">
					<div class="text-center">
						<a href=""> <img
							class="w-75 animate__animated animate__zoomInUp"
				...
				<div
					class="col-lg-4 col-md-6 d-flex justify-content-center align-items-center mg-t-sm">
					...
					<div class="ms-3">
						<a href="Servlet_Cart" class="text-black"><i
							class="bi bi-cart2 fs-4"></i></a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarNav">
						<ul class="navbar-nav text-uppercase fw-semibold">
							...
							<li class="nav-item slide-fwd-center"><a
								class="nav-link active" href="#"> Liên hệ</a></li>
							<li class="nav-item slide-fwd-center"><a
								class="nav-link active" href="#"> Fanpage</a></li>
